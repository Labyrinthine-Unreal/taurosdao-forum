// src/pages/topics/forum_slug/[slug].js
    ...
    <div>
      ...
      <div className={styles.container}>
        <div className={styles.tableContainer}>
            ...
            <tbody>
              <tr>
                <td className={styles.leftColumn}>
                  <div>{topicData.user}
                  {data?.general_by_slug.eth_address}
                  </div>
                ...
                <div className={styles.titleBlock}>
                  ...
                  {isAuthor && 
                    ...
                    >
                      <div>
                        {isAuthor && showEdit &&
                          <UpdateTopic category="general" setShowEdit={setShowEdit} />}
          ...
          <ReplyButton category="general" />
          <GPT />
          <CommentList category="general" />
        </div>
      </div>
    </div>
  );
