// src/components/topicComponents/Game/UpdateTopic.js
...
const UpdateTopic = ({ onPostCreated }) => {
    ...
    const { data, loading, error } = useQuery(GET_TOPIC_BY_SLUG, {
      ...
      console.log(data)
      console.log(data?.game_by_slug.slug)
    ...
    //   const isAuthor = user.username === data?.game_by_slug.user // check if current user is the author
      ...
      console.log(data?.game_by_slug._id)
    ...
    const handleSubmit = (e) => {
        ...
        var createP = client.query(
            q.Update(
                q.Ref(q.Collection('game'), data?.game_by_slug._id),
