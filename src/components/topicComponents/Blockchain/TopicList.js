// src/components/topicComponents/Blockchain/TopicList.js
...
export default function TopicList() {
 ...
 const handleNewTopic = () => {
  router.push('/categories/blockchain/create-new-topic');
};
  ...
  <Text>Chakra UI</Text>
          ...
          <table className={styles.topicTable}>
            ...
            <tbody>
              {data.blockchain_by_id.data.map((item) => {
                ...
                return (
                  <tr key={item.id} className={styles.topicRow}>
                    ...
                    <td>
                      ...
                      <Link href={`/topics/blockchain_slug/${item.slug}`}>
