// src/components/commentComponents/Blockchain/CommentList.js
...
const CommentList = () => {
  ...
  useEffect(() => {
    if (data?.blockchain_by_slug.slug) {
      var createP = client.query(
        q.Paginate(q.Match(q.Index("getblockchainCommentsBySlug"), data?.blockchain_by_slug.slug))
      );
